 ...
 * under the License.
 */
package com.birin.cursorgridadapter.demo6;
...
public class UnlimitedCursorItemsRotationClickToLoadMore extends
		UnlimitedCursorItemsRotationSupportAutoLoadMore implements
		OnClickListener {
	...
	protected void updateLoadMoreView() {
		if (dataRetainingFragment.canLoadMoreData(listviewAdapter
				.getAbsoluteCardsCount()) == false) {
